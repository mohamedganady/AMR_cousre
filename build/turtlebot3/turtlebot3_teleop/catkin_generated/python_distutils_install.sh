...
echo_and_run cd "/home/mohamed/AMR/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/mohamed/AMR/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/mohamed/AMR/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
